## =====================================================================
## 50_run_msom_sim_v2.R -- replicated multi-species simulation
## =====================================================================
## VERSION 2. Supersedes 50_run_msom_sim.R entirely; delete that file to
## avoid running a stale copy. Confirm on load that the banner below
## reports "v2 | linear covariate".
##
## Changes from v1:
...
run_msom_rep <- function(r) {
  ...
  init_worker()
  sim <- simulate_msom(DOM, site_frac = SIM$site_frac, seed = SEED_BASE + r)

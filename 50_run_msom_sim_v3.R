...
## =====================================================================
## VERSION 3. Supersedes v2. Confirm on load that the banner reports
## "v3 | homogeneous slopes".
##
...
run_msom_rep <- function(r) {
  ...
  init_worker()
  ## sd_beta1 = 0: all species share the community slope exactly.
  sim <- simulate_msom(DOM, site_frac = SIM$site_frac, sd_beta1 = 0,
                       seed = SEED_BASE + r)
